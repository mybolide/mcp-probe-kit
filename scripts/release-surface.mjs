...
export const COMPACT_TOOL_COUNT = manifest.toolsets?.compact?.count ?? 23;
export const COMPACT_WITH_MEMORY_TOOL_COUNT =
  manifest.toolsets?.compactWithMemory?.count ?? 29;
...
export const FULL_TOOL_COUNT = manifest.toolsets?.full?.count ?? manifest.totalTools ?? 33;
