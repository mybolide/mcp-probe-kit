 ...
 * 
 * - core: 15 个核心工具（高频使用）
 * - ui: 6 个 UI/UX 工具（推荐使用 start_ui 统一入口）
 * - workflow: 25-30 个工作流工具（包含 core + 编排工具）
 * - full: 所有 49 个工具（默认）
 */
export const TOOLSET_DEFINITIONS = {
  ...
  // UI/UX 工具集（6 个）- 对外工具，推荐使用 start_ui 统一入口
  ui: [
    'start_ui',         // ⭐ 统一入口（编排工具）
