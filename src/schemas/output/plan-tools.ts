...
export const ResumePlanResultSchema = {
  ...
  properties: {
    ...
    selection: { type: 'string', enum: ['explicit', 'latest-resumable'] },
    mustContinue: { type: 'boolean' },
    nextStep: { type: ['object', 'null'], additionalProperties: true },
    nextTool: { type: ['string', 'null'] },
    nextArgs: { type: 'object', additionalProperties: true },
    nextAgentAction: { type: ['string', 'null'] },
    continuationContract: { type: 'object', additionalProperties: true },
