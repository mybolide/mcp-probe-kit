  ...
  try {
    ...
    return okStructured(
        ...
        : `❌ Plan 尚未收敛: ${planId}\n- ${result.blockers.join('\n- ')}`,
      {
        ...
        requiredEvidenceKinds: result.record.lastConvergence?.requiredEvidenceKinds ?? [],
        requiredQualityGates: result.requiredQualityGates,
        missingQualityGates: result.missingQualityGates,
