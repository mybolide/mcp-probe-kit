...
### 33. init_project_context - 生成项目上下文
**用途：** 生成技术栈/架构/编码规范文档
...
### 40. gen_skill - 生成 Agent Skills 文档
**用途：** 为工具生成技能文档
